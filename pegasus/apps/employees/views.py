...
def _add_edit_employee(request, employee: Employee | None = None):
    if employee and employee.user != request.user:
        raise PermissionError("Cannot edit employee that belongs to a different user")
