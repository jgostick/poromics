...
team_urlpatterns = (
    [
        ...
        path("network-validation/", views.network_validation_launch, name="network_validation_launch"),
        path("network-validation/network-jobs/", views.network_jobs_for_image, name="network_jobs_for_image"),
